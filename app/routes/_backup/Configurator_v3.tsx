        ...
        {LIJNEN.map((l) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="product-line-card-media"
                style={{
                  flexShrink: 0,
                  position: "relative",
                  overflow: "hidden",
...
export default function App() {
  ...
  const CSS = `
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .option-card-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8}
    .product-line-card{display:flex;flex-direction:column;container-type:inline-size;min-width:0}
    .product-line-card-media{width:100%;min-height:136px}
    .style-card-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:12}
    @media(min-width:640px){.option-card-grid{grid-template-columns:repeat(auto-fill,minmax(256px,1fr))}}
    @container (min-width: 520px){.product-line-card{flex-direction:row}.product-line-card-media{width:42%;min-height:120px}}
